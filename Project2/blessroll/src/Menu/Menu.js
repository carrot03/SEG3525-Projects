...
function Menu() {
  ...
  const [state, setState] = useState({
    ...
    facets: {
      ...
      ingredients: build_categorical_facet_values('ingredients')
    }
  })
  ...
  function updateTable(itemId){
    ...
    const specificId = item; // Specify the ID you want to select

    const specificMenuItem = state.all_menu.find(menuItem => menuItem.id === specificId);
